...
class text:
    ...
    def creat(self):
        # 创建一个输入组件
        # self.aw = Label
        self.face = Label(relief=RAISED, font=('宋体', 17),height = 4,width=21, bg='white', anchor=SE,wraplength=300)
...
justify = 'left')
        ...
        b = Button(p, text='7', font=('微软雅黑', 20), height=1, width=5, bd=1).pack(side=)
